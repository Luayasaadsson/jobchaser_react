...
Starta applikationen genom att köra kommandot npm start i terminalen och öppna sedan webbläsaren och navigera till den angivna URL:en.
...
### Spåra intressanta jobb

Användare kan spara intressanta jobb genom att klicka på bokmärkesikonen bredvid varje jobb. Sparade jobb visas i en separat lista där användare kan spåra deras status och åtgärder.
